    ...
    <div className={`fixed bottom-0 left-0 right-0 z-40 md:hidden transition-transform duration-300 ${visible ? 'translate-y-0' : 'translate-y-full'}`}
      ...
      <div className="flex border-t border-white/10" style={{ background: '#1A1713' }}>
        ...
        <a
          ...
          className="flex flex-col items-center justify-center gap-0.5 text-white/60 hover:text-[#25D366] transition-colors border-x border-white/8"
          style={{ minHeight: '56px', width: '60px' }}
          aria-label="WhatsApp The White Hart"
        >
          ...
          <span className="font-label text-[9px] uppercase tracking-wide">WhatsApp</span>
        </a>
